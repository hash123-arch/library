...
if(isset($_POST['delete'])){
    ...
    $sql = "DELETE FROM author WHERE ID = '$del_id'";

    $result = $conn->query($sql);

    if($result == TRUE){

        $message1 = '<div class="alert alert-success">An Author is SuccessFully Deleted</div>';
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card-header">
                <h4 class="display-5 text-danger">View List of Authors</h4>
            </div>
