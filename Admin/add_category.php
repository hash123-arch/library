...
$category->Book_category = $_POST['Category_name'];

$category->category_status = $_POST['Btn-1'];
...
$message='<div class="alert alert-success">A New Category Added !!<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
...
<html lang="en">
  ...
  <div class="container mt-5">
        ...
        <h1 class="text-center text-warning display-5">Add A Book Category</h1>
      ...
      <?php echo $message;  ?>
        ...
        <input type="submit" name="save" value="Insert Category" class="btn btn-success mt-5">
